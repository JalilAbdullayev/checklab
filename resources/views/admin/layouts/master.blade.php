            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="{{ route('admin.index') }}">
                    <!-- Logo icon --><b>
                        ...
                        <!-- Dark Logo icon -->
                        <img src="back/images/logo-icon.png" alt="homepage" class="dark-logo"/>
                        <!-- Light Logo icon -->
                        <img src="back/images/logo-light-icon.png" alt="homepage" class="light-logo"/>
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text --><span>
						 <!-- dark Logo text -->
						 <img src="back/images/logo-text.png" alt="homepage" class="dark-logo"/>
                        <!-- Light Logo text -->
						 <img src="back/images/logo-light-text.png" class="light-logo" alt="homepage"/></span> </a>
            </div>
            <!-- End Logo -->
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="message-center">
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"><img src="back/images/users/1.jpg" alt="user"
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"><img src="back/images/users/2.jpg" alt="user"
                                                                       class="img-circle"> <span
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"><img src="back/images/users/3.jpg" alt="user"
                                                                       class="img-circle"> <span
                                        ...
                                        <!-- Message -->
                                        <a href="javascript:void(0)">
                                            <div class="user-img"><img src="back/images/users/4.jpg" alt="user"
                                                                       class="img-circle"> <span
                                        ...
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <div class="container"><img class="d-block img-fluid"
                                                                            src="back/images/big/img1.jpg"
                                                                            alt="First slide"></div>
                                            </div>
                                            <div class="carousel-item">
                                                <div class="container"><img class="d-block img-fluid"
                                                                            src="back/images/big/img2.jpg"
                                                                            alt="Second slide"></div>
                                            </div>
                                            <div class="carousel-item">
                                                <div class="container"><img class="d-block img-fluid"
                                                                            src="back/images/big/img3.jpg"
                                                                            alt="Third slide"></div>
                                            </div>
                                        </div>
