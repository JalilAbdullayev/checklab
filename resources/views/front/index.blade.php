							...
							<div class="col-lg-8">
								<div class="banner-row-item bg-gray banner-item">
									...
									<div class="banner_text">
										...
										<a href="{{ route('product.index', $allProducts[0]->slug) }}">buy now</a>
									</div>
								</div>
							</div>
							<div class="col-lg-4">
								<div class="banner-column-item banner-item bg-blue">
									<div class="banner_text">
										...
										<a href="{{ route('product.index', $allProducts[1]->slug) }}">buy now</a>
									</div>
									<div class="banner_img">
								...
								<div class="col-lg-4">
									<div class="banner-column-item banner-item bg-blue">
										<div class="banner_text">
											...
											<a href="{{ route('product.index', $allProducts[2]->slug) }}">buy now</a>
										</div>
										<div class="banner_img">
								...
								<div class="col-lg-4">
									<div class="banner-column-item banner-item bg_light">
										<div class="banner_text">
											...
											<a href="{{ route('product.index', $allProducts[3]->slug) }}">buy now</a>
										</div>
										<div class="banner_img">
					...
					<div class="col-lg-4">
						<div class="banner-column-item banner-item banner-big-item bg-purple">
							<div class="banner_text">
								...
								<a href="{{ route('product.index', $allProducts[4]->slug) }}">buy now</a>
							</div>
							<div class="banner_img">
